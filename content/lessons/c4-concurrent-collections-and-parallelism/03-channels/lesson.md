...
order: 3
title: Channels  -  the Modern Producer-Consumer Pipe
difficulty: advanced
...
interview:
  - q: What is a Channel in .NET?
    a: A Channel is a modern thread-safe pipe between a producer and a consumer. One side writes items (Writer), the other reads them (Reader). It supports bounded capacity (back-pressure  -  writer waits when full) and async/await natively.
