...
order: 9
title: "Parallel.ForEach  -  Beyond Parallel.For"
...
interview:
  ...
  - q: "Does Parallel.ForEach guarantee ordering of results?"
    a: "No  -  items are processed in parallel and may complete in any order. If you need ordered results, use PLINQ's AsOrdered() or collect results with an index-based array. ForEach itself provides no ordering."
---
