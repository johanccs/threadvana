...
order: 9
title: "Parallel.ForEach Ã Â¢Ã¢â  Â¬ Beyond Parallel.For"
...
interview:
  ...
  - q: "Does Parallel.ForEach guarantee ordering of results?"
    a: "No Ã Â¢Ã¢â  Â¬ items are processed in parallel and may complete in any order. If you need ordered results, use PLINQ's AsOrdered() or collect results with an index-based array. ForEach itself provides no ordering."
---
...
> **Don't use Parallel.ForEach for I/O.** It blocks pool threads waiting for I/O Ã Â¢Ã¢â  Â¬ use `Task.WhenAll` with async instead.
