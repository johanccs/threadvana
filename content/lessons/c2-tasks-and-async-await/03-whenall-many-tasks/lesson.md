...
order: 3
title: Task.WhenAll Ã Æ Ã Â¢Ã Â¢Ã¢â ¬Å¡Ã Â¬Ã Â¢Ã¢â  Â¬Ã Â  Run Many Things at Once
...
The fast way: eggs on, bacon in the pan, bread in the toaster Ã Æ Ã Â¢Ã Â¢Ã¢â ¬Å¡Ã Â¬Ã Â¢Ã¢â  Â¬Ã Â  all started
...
The key idea: **calling** an async method already starts the work Ã Æ Ã Â¢Ã Â¢Ã¢â ¬Å¡Ã Â¬Ã Â¢Ã¢â  Â¬Ã Â  the receipt
...
task to finish Ã Æ Ã Â¢Ã Â¢Ã¢â ¬Å¡Ã Â¬Ã Â¢Ã¢â  Â¬Ã Â  handy when several workers race and you only need the fastest.
...
- You might `await` each task before starting the next one. The tasks never
  overlap Ã Æ Ã Â¢Ã Â¢Ã¢â ¬Å¡Ã Â¬Ã Â¢Ã¢â  Â¬Ã Â  you get the staircase, not the stack. Start everything first.
- You might think `WhenAll` starts the tasks. They are already running Ã Æ Ã Â¢Ã Â¢Ã¢â ¬Å¡Ã Â¬Ã Â¢Ã¢â  Â¬Ã Â 
