...
order: 20
title: Capstone Ã¢â‚¬â€ Mini Download Manager
difficulty: advanced
...
interview:
  - q: How would you design a system where N worker threads process items from a shared queue?
    a: "Use a shared queue (ConcurrentQueue or BlockingCollection) and start N dedicated threads. Each worker loops Ã¢â‚¬â€ dequeue, process, repeat. The main thread enqueues work and signals when done. Shut down cooperatively when the queue is empty and the producer is finished."
  - q: What happens if a worker thread crashes?
    a: The other workers keep running Ã¢â‚¬â€ they are independent. But the crashed worker's item may be lost unless you catch exceptions inside the worker loop and re-queue or log the failure. Use try/catch in the worker body.
---
...
```
Main thread Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€“Âº enqueue(12 items) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€“Âº set stop flag Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€“Âº Join all workers
                    Ã¢â€â€š
                    Ã¢â€“Â¼
[shared queue] Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€“Âº Worker 1 Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€“Âº Worker 2 Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€“Âº Worker 3 Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€“Âº Worker 4
```
...
dequeue, and a cooperative stop flag Ã¢â‚¬â€ almost everything from Category 1.
...
Notice how workers overlap Ã¢â‚¬â€ while one processes, another dequeues the next item.
