...
order: 14
title: Telling a Thread to Stop Ã¢â‚¬â€ Cooperative Cancellation
...
interview:
  - q: How do you stop a running thread?
    a: "You do not stop a thread by force (Thread.Abort does not exist on .NET Core). Instead ask it to cooperate Ã¢â‚¬â€ a bool flag the worker checks regularly. In modern .NET, CancellationToken is the standard."
