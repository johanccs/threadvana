...
The starter starts a loop that counts from 1 to 1,000,000,000 — it runs forever. Your
...
The harness checks that the worker stopped EARLY (Count < 200,000,000 — way before
