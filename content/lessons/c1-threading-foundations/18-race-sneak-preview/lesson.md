...
order: 18
title: Race Conditions  -  a Sneak Preview
...
interview:
  - q: What is a race condition?
    a: When two or more threads access shared data and the result depends on who gets there first (the timing "race"). A classic example is two threads doing counter++ on a shared variable  -  the increments can be lost because ++ is not one atomic operation.
  - q: How do you fix a race condition?
    a: "With synchronization  -  a lock, Interlocked operations, or thread-safe data structures like ConcurrentDictionary. Category 3 covers these in depth."
---
