...
order: 11
title: "Mutex Ã Â¢Ã¢â  Â¬ the Cross-Process Key"
...
> **Always Release the mutex.** Unlike lock (Monitor), the CLR does not auto-release on thread exit Ã Â¢Ã¢â  Â¬ you must call ReleaseMutex explicitly, ideally in a try/finally block.
...
- `Mutex` Ã Â¢Ã¢â ¬Â  kernel-level, cross-process mutual exclusion.
